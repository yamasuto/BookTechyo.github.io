...
~~.NET 10.0 ランタイムが必要です。PCにインストールしていない場合は、<https://dotnet.microsoft.com/download>から .NET 10.0ランタイム をダウンロードしてインストールしてください。~~
...
他のアプリでISBNや解析可能な書籍の説明をコピーした場合には、上に加えて「読み取る」 ![読み取る](../../common/images/content_paste_32dp_000000_FILL0_wght400_GRAD0_opsz40.png)を表示します。
...
- ![expanding](../../common/images/expand_circle_down_32dp_000000_FILL0_wght400_GRAD0_opsz40.png) 詳細をクリックすると、エクスパンダー（出版社、ISBN、ページ数、出版年月日、URL、画像、説明、出典を内包する）を展開して表示します。![shrink](../../common/images/expand_circle_up_32dp_000000_FILL0_wght400_GRAD0_opsz40.png)をクリックすると、エクスパンダーを畳み非表示にします。

タイトルおよび著者をクリックするとPopupを表示します。タイトル、著者を指定して![apply](../../common/images/check_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックしてください。変更を破棄して元の表示に戻るには、![cancel](../../common/images/cancel_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックします。
...
[状態]では**チェックあり**の状態だけを一覧に表示します。クリックしてチェックありなしを切り替え、![filter](../../common/images/filter_alt_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックすると、一覧の表示を更新します。

![BottomSheet](./images/resized/01_Records_N230_BooksPageFilter.png)

[読了年]に年を指定して、![filter](../../common/images/filter_alt_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックすると、一覧に指定した年に読み終わった本の記録だけ表示します。一番面白かった本を検討する際に、一年間に読んだ本だけ表示できるように作りました。

[賞]は[スイッチ]をオンにして、![filter](../../common/images/filter_alt_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックすると、一覧に賞有りだけ表示します。
...
右上[メニュー]の[初期設定に戻す]か![Restore](../../common/images/reset_settings_32dp_1F1F1F_FILL0_wght400_GRAD0_opsz40.png)をクリックするとフィルターと並び替えを初期設定に戻し、一覧を更新します。
